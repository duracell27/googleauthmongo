...
const Home = () => {
  return (
    <div className='h-screen bg-green-500 flex flex-col gap-10 items-center text-white' >
        ...
        <div className="p-2 m-2 shadow-lg shadow-black/30 text-lg font-bold bg-green-600 text-center rounded-lg">Версія - <span className='bg-slate-800 rounded-lg mb-2 px-1'>0.04</span>
